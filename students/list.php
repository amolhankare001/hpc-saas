...
$stmt = $db->prepare("SELECT s.*, t.name_mr as teacher_name_mr, t.name as teacher_name FROM students s LEFT JOIN teachers t ON s.teacher_id = t.id $where ORDER BY s.name_mr ASC, s.name ASC LIMIT $per_page OFFSET $offset");
$stmt->execute($params);
